...
const Header: React.FC = () => {
  ...
  {headerData.map((item, index) =>
    item.label === "Contato" ? (
      <a
        ...
        className="bg-primary text-white font-medium px-6 py-2 rounded-lg hover:bg-transparent hover:text-primary border border-primary transition"
      >
        {item.label}
      </a>
    ) : (
  ...
  {headerData.map((item, index) =>
    item.label === "Contato" ? (
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="text-sm bg-primary text-white px-3 py-2 rounded-md font-medium hover:bg-blue-700 transition"
    >
      {item.label}
    </a>
